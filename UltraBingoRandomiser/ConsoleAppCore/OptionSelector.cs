    ...
    public void PrintOptionSelector(bool useNumber, out int option)
    {
        do
        {
            ...
            switch (keyInfo.Key)
            {
                ...
                case ConsoleKey n when useNumber && n.IsBetween(ConsoleKey.D1, ConsoleKey.D9):
                    if ((int)keyInfo.Key - (int)ConsoleKey.D1 >= options.Length)
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        ConsoleUtility.ClearLine(Console.CursorTop);
                ...
                case ConsoleKey n when useNumber && n.IsBetween(ConsoleKey.NumPad1, ConsoleKey.NumPad9):
